...
import com.dat.androidhmi.composetodolist.foundation.extension.toToDoColor
...
) : StatefulViewModel<ListDetailState, ListDetailEffect, ListDetailAction, IListDetailEnvironment>(
    ListDetailState(), listDetailEnvironment) {
