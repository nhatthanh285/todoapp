...
import com.dat.androidhmi.composetodolist.runtime.navigation.ARG_GROUP_ID
...
class UpdateGroupListViewModel @Inject constructor(
    ...
    StatefulViewModel<UpdateGroupListState, Unit, UpdateGroupListAction, IUpdateGroupListEnvironment>(
        UpdateGroupListState(), updateGroupListEnvironment) {
